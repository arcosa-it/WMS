...
public class IngresosController {
    ...
    public @ResponseBody String leerExcel(Model model,HttpServletRequest request, HttpServletResponse response){
        ...
        try{
            ...
            for (int i=0; i<sheet.getRows(); i++){
                ...
                ingresos.setMarca(sheet.getCell(5,i).getContents());
